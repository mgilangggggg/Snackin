      ...
      <main className="max-w-5xl mx-auto bg-white p-8 shadow-lg mt-6 rounded-lg">
        ...
        <div className="space-y-6 mb-6">
          {items.map(item => (
            <div key={item.id} className="flex items-center space-x-4 border-b pb-4">
              ...
              <p className="text-lg font-bold">Rp. {(item.price * item.quantity).toLocaleString()}</p>
            </div>
          ))}
        </div>
        ...
        <div className="text-right space-y-2 mb-6">
          ...
          <div className="flex justify-between items-center font-bold text-lg w-full bg-red-500 text-white p-4 rounded">
            ...
            <span className="text-white-500">Rp. {total.toLocaleString()}</span>
          </div>
        </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              <label className="flex items-center space-x-2">
                ...
                <img src="src/Assets/Shipping/JNE.png" alt="JNE" className="w-16" />
              </label>
              <label className="flex items-center space-x-2">
                <input type="radio" name="shipping" />
                <img src="src/Assets/Shipping/JNT.png" alt="J&T Express" className="w-16" />
              </label>
            </div>
          </div>
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <label className="flex items-center space-x-2">
                ...
                <img src="src/Assets/Payment/bri.png" alt="BRI" className="w-16" />
              </label>
              <label className="flex items-center space-x-2">
                <input type="radio" name="payment" />
                <img src="src/Assets/Payment/bca.png" alt="BCA" className="w-16" />
              </label>
              <label className="flex items-center space-x-2">
                <input type="radio" name="payment" />
                <img src="src/Assets/Payment/dana.png" alt="Dana" className="w-16" />
              </label>
              <label className="flex items-center space-x-2">
                <input type="radio" name="payment" />
                <img src="src/Assets/Payment/mandiri.png" alt="Mandiri" className="w-16" />
              </label>
            </div>
          </div>
        </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          <div className="bg-white p-6 rounded-lg shadow-lg text-center">
            <p className="text-lg font-bold mb-4">Pembayaran telah diverifikasi</p>
            <img src="src/Assets/Payment/verification-success.png" alt="Verified" className="w-16 h-16 mx-auto mb-4" />
            <button className="bg-red-500 text-white px-4 py-2 rounded" onClick={() => setIsPaymentVerified(false)}>
              Selanjutnya
            </button>
          </div>
          </div>
